...
exports.FlashsellController = void 0;
const common_1 = require("@nestjs/common");
const platform_express_1 = require("@nestjs/platform-express");
const multer_1 = require("multer");
const flashsell_service_1 = require("./flashsell.service");
const create_flashsell_dto_1 = require("./dto/create-flashsell.dto");
const update_flashsell_dto_1 = require("./dto/update-flashsell.dto");
...
let FlashsellController = class FlashsellController {
    constructor(flashsellService) {
        this.flashsellService = flashsellService;
    ...
    async create(createFlashsellDto, file) {
        if (file) {
    ...
    async update(id, updateFlashsellDto, file) {
        if (file) {
...
exports.FlashsellController = FlashsellController;
__decorate([
    (0, common_1.Post)(),
    ...
    __metadata("design:paramtypes", [create_flashsell_dto_1.CreateFlashsellDto, Object]),
    __metadata("design:returntype", Promise)
], FlashsellController.prototype, "create", null);
__decorate([
    (0, common_1.Get)(),
    ...
    __metadata("design:returntype", Promise)
], FlashsellController.prototype, "findAll", null);
__decorate([
    (0, common_1.Get)(':id'),
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    ...
    __metadata("design:returntype", Promise)
], FlashsellController.prototype, "findOne", null);
__decorate([
    (0, common_1.Patch)(':id'),
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    (0, common_1.UseInterceptors)((0, platform_express_1.FileInterceptor)('image', { storage: storageConfig, fileFilter: fileFilterConfig })),
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, update_flashsell_dto_1.UpdateFlashsellDto, Object]),
    __metadata("design:returntype", Promise)
], FlashsellController.prototype, "update", null);
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], FlashsellController.prototype, "remove", null);
exports.FlashsellController = FlashsellController = __decorate([
    (0, common_1.Controller)('flashsell'),
    __metadata("design:paramtypes", [flashsell_service_1.FlashsellService])
], FlashsellController);
//# sourceMappingURL=flashsell.controller.js.map