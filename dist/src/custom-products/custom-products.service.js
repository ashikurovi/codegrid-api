...
let CustomProductsService = class CustomProductsService {
    constructor(customProductRepository) {
    ...
    async findOne(id) {
        ...
        if (!product) {
            throw new common_1.NotFoundException(`Custom Product with ID ${id} not found`);
        }
        return product;
    }
...
exports.CustomProductsService = CustomProductsService = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(custom_product_entity_1.CustomProduct)),
