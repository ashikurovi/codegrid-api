...
export class MailService {
  ...
  async sendNewOrderNotification(order: {
    ...
    const safe = (value?: string | number) => String(value ?? 'Not provided')
      .replace(/&/g, '&amp;')
      .replace(/</g, '&lt;')
      .replace(/>/g, '&gt;')
      .replace(/"/g, '&quot;');
